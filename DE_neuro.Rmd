---
title: "Neuro RNA-seq DE analysis"
...
### Get the file names
```{r}
countFiles <- list.files(file.path(dir, "bunina/LSD1/differentiation/Neuro/data/bams/"),
                         pattern = "bam$",
                         full.names = TRUE
                         )
...
# 
# saveRDS(se,
#         file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/se.rds")
# )
# 
se <- readRDS(file = file.path(dir1, "oheachte/LSD1/neur_RNAseq/Saved_objects/se.rds"))
```
...
```{r}
dds_neur <- DESeqDataSet(se, design = ~family+condition)
# 
dds_counts = counts(dds_neur)
# 
dds_neur <- dds_neur[rowSums(dds_counts) >= 30]     # Filter out low count genes
# dds_counts = counts(dds)
# 
dds_neur <- DESeq(dds_neur)
# rownames(dds) <- sapply(strsplit(rownames(dds), '[.]'), '[[', 1)
# 
saveRDS(dds_neur, file = file.path(dir1, "bunina/LSD1/differentiation/dds_neur_new.rds"))
...
if(SAVE_OBJECTS == TRUE){
  saveRDS(top_names,
          file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/top_names/top_names.rds"))
  saveRDS(top_names_up,
          file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/top_names/top_names_up.rds"))
  saveRDS(top_names_down,
          file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/top_names/top_names_down.rds"))
  write.csv(top_names,
          file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/top_names/top_names.csv"))
  write.csv(top_names_up,
          file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/top_names/top_names_up.csv"))
  write.csv(top_names_down,
          file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/top_names/top_names_down.csv"))
}
```
...
pdf(file = file.path(dir1, "bunina/LSD1/differentiation", "PCA_neuro.pdf"), width = 6, height = 4.5, useDingbats = FALSE)
p
dev.off()
```
...
pdf(file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_PCA/dotplots.pdf"))
for (PC in c("PC1", "PC2", "PC3", "PC4")){
  ...
  #                                            )  # GO object
  # 
  # saveRDS(goBP_PC, file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_PCA", paste0("goBP_", PC, ".rds")
  #                                   )
  #         )
  goBP_PC <- readRDS(file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_PCA", paste0("goBP_", PC, ".rds")
                                     )
                    )
...
# df_summary <- cbind(tissue = "neur", df_summary)
# write.csv(df_summary,
#           file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_PCA/genesWithLargestPCcoefs.csv")
#           )

# translate(c(loadedGenes(pcaObj, "PC1", 20, "up"), "NA", loadedGenes(pcaObj, "PC1", 20, "down")))

# goBP_PC1 <- readRDS(file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_PCA", paste0("goBP_", "PC1", ".rds")
#                                      )
#                     )
```
...
```{r}
# goObj_MF <- clusterProfiler::compareCluster(geneClusters = geneList,
#                                             fun = "enrichGO",
#                                             keyType = "ENSEMBL",
#                                             OrgDb = org.Hs.eg.db,
#                                             ont = "MF",
...
#                                             )
# 
# saveRDS(goObj_MF, file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_MF.rds"))

goObj_MF <- readRDS(file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_MF.rds"))
...
```{r}
# goObj_BP <- clusterProfiler::compareCluster(geneClusters = geneList,
#                                             fun = "enrichGO",
#                                             keyType = "ENSEMBL",
#                                             OrgDb = org.Hs.eg.db,
#                                             ont = "BP",
...
#                                             )
# 
# saveRDS(goObj_BP, file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_BP.rds"))

goObj_BP <- readRDS(file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_BP.rds"))
...
```{r}
# goObj_CC <- clusterProfiler::compareCluster(geneClusters = geneList,
#                                             fun = "enrichGO",
#                                             keyType = "ENSEMBL",
#                                             OrgDb = org.Hs.eg.db,
#                                             ont = "CC",
...
#                                             )
# 
# saveRDS(goObj_CC, file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_CC.rds"))

goObj_CC <- readRDS(file = file.path(dir, "oheachte/LSD1/neur_RNAseq/Saved_objects/goObj_CC.rds"))
